...
export default function ValueBanner({ onOpenBooking }: ValueBannerProps) {
  ...
  return (
    <section className="relative py-24 lg:py-32 w-full bg-[#0a0a0c] overflow-hidden border-t border-b border-white/10">
      {/* Full Width 2nd Image Background Visual */}
      ...
      {/* Full Width Container for Overlay Content */}
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 px-8 py-4 text-xs font-bold uppercase tracking-wider text-white bg-[#ff3847] hover:bg-[#e62e3d] rounded-full shadow-lg shadow-[#ff3847]/30 hover:scale-105 transition-all"
              >
            ...
            <div className="w-full max-w-md p-6 sm:p-8 rounded-3xl bg-[#0c0e14]/85 border border-white/15 backdrop-blur-xl shadow-2xl space-y-6 text-left">
              {valueItems.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="w-12 h-12 rounded-2xl bg-[#ff3847]/15 border border-[#ff3847]/30 flex items-center justify-center shrink-0">
